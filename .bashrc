alias cass='ssh matiaskj@cassarossa.samfundet.no'
alias cirkus='ssh matiaskj@cirkus.samfundet.no'
alias norse="ssh matiaskj@norse.samfundet.no"
alias conn='tmux a -d'
alias cls='clear'
...
if [ "$color_prompt" = yes ]; then
	PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\] ƒ '
else
